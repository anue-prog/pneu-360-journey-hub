...
import teamImage from "@/assets/team-pneu360.webp";
...
function AnimatedStat({ end, suffix, label, staticVal, delay, accent }: { end: number; suffix: string; label: string; staticVal?: string; delay: number; accent?: boolean }) {
  ...
  return (
    ...
    >
      <p className={`font-display text-[clamp(48px,8vw,80px)] tracking-[-0.04em] leading-none ${accent ? 'text-brand-accent' : 'text-foreground'}`}>
  ...
  <section className="bg-card py-32 md:py-44 lg:py-56 px-3 md:px-6">
    <div className="max-w-[1400px] mx-auto">
      <div className="relative mb-20 md:mb-32">
        ...
        >
          Modern.<br />Unkompliziert.
        </motion.h2>
      </div>

      <motion.p {...fadeIn()} className="text-brand-body text-muted-foreground max-w-xl mb-16 md:mb-20">
      ...
      <motion.div {...fadeIn()} className="mb-20 md:mb-32 -mx-3 md:-mx-6">
        <img src={teamImage} alt="Team Pneu 360" className="w-full aspect-[21/9] object-cover" loading="lazy" />
      </motion.div>
